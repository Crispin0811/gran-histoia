...
window.addEventListener("load", () => {
  ...
  if (anniversaryDate) {
    ...
    document.getElementById(
      "daysCount"
    ).innerText = `Ya han pasado ${years} ${yearText}, ${months} ${monthText} y ${days} ${dayText}, desde que volvió a reescribirse nuestra historia. Me alegró mucho regresar contigo y estar nuevamente juntos. Estar de nuevo y disfrutando nuestros momentos de locura, eres la persona con la que quiero compartir gran parte de mi vida. ¡Te Amo ❤️!`;
  }
});
...
const mensajes = [
    ...
    "Contigo, cada momento es especial, chiquita. 🌟",
    "Tu amor es mi mayor tesoro y lo cuidaré siempre. 🏆",
